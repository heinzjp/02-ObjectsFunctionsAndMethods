...
def main():
    ...
    #better_draw_circles(rg.Point(100, 50), 22)
    #better_draw_circles(rg.Point(-200, 0), 30)

    #even_better_draw_circles(rg.Point(100, 50), 20, 5, 'red', 10)
    #even_better_draw_circles(rg.Point(-200, 0), 12, 15, 'blue', 5)

    beautiful('blue', 30, 10, 10)
...
def better_draw_circles(point, increment):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(increment * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, increment, number, color, thickness):
...
def beautiful(color, number, angle, increment):
    turtle = rg.SimpleTurtle()
    turtle.pen = rg.Pen(color, 5)
    turtle.go_to(rg.Point(0,0))
