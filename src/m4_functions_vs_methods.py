...
def try_methods_and_functions():
    ...
    jake.pen = rg.Pen('blue', 5)
    jake.backward(150)
    jake.speed = 1
    for k in range(2):
        jake.draw_square(100)
        jake.left(30)
    jake.speed = 5
    jake.pen = rg.Pen('red', 5)
    for k in range(10):
        jake.draw_square(50)
        jake.left(15)
    jake.speed = 100
    jake.pen = rg.Pen('red', 35)
    for k in range(8):
        jake.draw_square(300)
        jake.left(60)
    jake.pen = rg.Pen('black', 3)
    jake.backward(200)
    jake.draw_circle(30)
    jake.draw_square(50)
